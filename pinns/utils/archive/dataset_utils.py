...
def plot_output(f, k, p_l, p_r, NN):
    ...
    def nn_approximation_2(x):
        ...
        for i in x:
            ...
            # print(x)
            pred_NN = NN.model(x).numpy()[0]

            res = (1 - x) - x + (1 - x) * x * pred_NN

            # print(res)
            result.append(res.numpy()[0])
        return result
