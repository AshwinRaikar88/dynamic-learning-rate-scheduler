...
from dlrs_utils.dlrs import DLRS


parser = argparse.ArgumentParser(description='PyTorch CIFAR10 Training')
parser.add_argument('--lr', default=0.005, type=float, help='learning rate')
parser.add_argument('--batchsize', default=128, type=int, help='batch size')
parser.add_argument('--deli', default=0.1, type=float, help='Delta i')
parser.add_argument('--deld', default=0.1, type=float, help='delta d')
...
# scheduler = torch.optim.lr_scheduler12e2d1d2d22df2qwf323fg43wvg3rebv.CosineAnnealingLR(optimizer, T_max=200)
...
for epoch in range(start_epoch, start_epoch+100):
    ...
    lr, loss_metrics = train(epoch, lr, optimizer)
    ...
    lr = scheduler.step(lr, loss_metrics)
    optimizer = optim.SGD(net.parameters(), lr=lr)

    # scheduler.step()
end = time.perf_counter()
with open('./data/results.txt', 'a+') as fl:
    fl.write('\n Optimizer is SGD, model is VGG19, LR is {}, \n test loss is{} \n test acc is {} \n \n'.
